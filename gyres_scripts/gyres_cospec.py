...
im3 = ax3.contourf(1/k,1/f,thihat.T/tlohat.T,v2,norm = LogNorm(),cmap=magma)
ax3.contour(1/k,1/f,thihat.T/tlohat.T,v2,colors='k',norm = LogNorm())
plt.colorbar(im3,ax=ax3)
ax3.set_yscale('log')
ax3.set_xscale('log')
ax3.set_xlim((1/k).min(),4e3)
ax3.set_ylim((1/f).min(),3e3)
ax3.set_title('T_high/T_low')
