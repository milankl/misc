...
eccoL = [a/4,lscale.max()]
eccotau = [3.,acftau.max()]
...
ax.add_patch(plt.Rectangle([xe,ye],we,he,color='g',alpha=.2))
ax.add_patch(plt.Rectangle([xe,ye],we,he,fill=False,edgecolor='k'))

ax.text(xe+1,ye+he-5,'ECCO2',verticalalignment='top')
...
ax.text(a+8,1.2,r'1$\degree{}$',rotation='vertical')
ax.text(a/4+1.5,1.5,r'1/4$\degree{}$',rotation='vertical')
ax.text(16,3.1,'3 days')
...
ax.set_title('Pot. Temp: Length and time scales of EOF modes')
plt.show()
